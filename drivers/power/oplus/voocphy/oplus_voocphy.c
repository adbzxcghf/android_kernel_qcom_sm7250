...
unsigned char oplus_voocphy_set_fastchg_current(struct oplus_voocphy_manager *chip)
{
	...
	voocphy_info("max_curr[%d] ap_curr[%d] temp_curr[%d] bcc_curr[%d] full_limit[%d]",
	              chip->current_max, chip->current_ap, chip->current_batt_temp, chip->current_bcc, chip->current_full_limit);
